    ...
    return (<>
        <div>
            <div className="flex justify-center items-center">
                <div className=" w-96 md:w-1/2 border border-slate-800 rounded-lg bg-black-950">
                    <div className="  flex rounded-t-lg justify-between my-2 border-b border-slate-800">
